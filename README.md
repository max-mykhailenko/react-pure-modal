# react-pure-modal [![npm package](https://img.shields.io/npm/v/react-pure-modal.svg?style=flat-square)](https://www.npmjs.org/package/react-pure-modal) [![Build Status](https://travis-ci.org/max-mykhailenko/react-pure-modal.svg?branch=master)](https://travis-ci.org/max-mykhailenko/react-pure-modal) [![Dependency Status](https://david-dm.org/max-mykhailenko/react-pure-modal.svg)](https://david-dm.org/max-mykhailenko/react-pure-modal) [![npm](https://img.shields.io/npm/dt/express.svg)](https://github.com/max-mykhailenko/react-pure-modal) [![npm](https://img.shields.io/npm/dm/localeval.svg)](https://github.com/max-mykhailenko/react-pure-modal)
